...
public class LineNumberComponent extends JComponent {
    ...
    /**
     * <p>
     * Checks and adjusts the width of this component based upon the line
     * numbers
     * <p>
     */
    public void adjustWidth() {
        ...
        int width = getGraphics().getFontMetrics().stringWidth(String.valueOf(
                max)) + 2 * HORIZONTAL_PADDING;
        ...
        if (width > getPreferredSize().width || width < getPreferredSize().width) {
            ...
            setPreferredSize(new Dimension(width + 2 * HORIZONTAL_PADDING,
                    dimension.height));
     ...
     *
     *
     * @param alignment One of RIGHT_ALIGNMENT, LEFT_ALIGNMENT, or
     *                  CENTER_ALIGNMENT
     *
        ...
        for (int i = 0; i < lineNumberModel.getNumberLines(); i++) {
            ...
            switch (alignment) {
                ...
                case RIGHT_ALIGNMENT:
                    ...
                    xPosition = getPreferredSize().width - g.getFontMetrics().
                            stringWidth(text) - HORIZONTAL_PADDING;

                    break;

                case CENTER_ALIGNMENT:

                    xPosition = getPreferredSize().width / 2 - g.
                            getFontMetrics().stringWidth(text) / 2;
